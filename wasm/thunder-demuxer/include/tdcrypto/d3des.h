#ifndef _CRYPTGENIUS_D3DES_H_INCLUDE
#define _CRYPTGENIUS_D3DES_H_INCLUDE
/* d3des.h -
 *
...
int des_isnot_weak_key(unsigned char * key,short keylen);



unsigned char * SetRandKey(unsigned char * RandKey);
